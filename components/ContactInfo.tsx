  ...
  return (
    <div className="flex justify-between">
      <div className="mx-auto mt-2">
        <h4 className="text-3xl text-text font-mont font-bold">Información de Contacto</h4>
        <p className="text-text font-pop">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
