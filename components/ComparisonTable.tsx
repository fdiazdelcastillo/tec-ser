...
const ComparisonTableCard: Component<ComparisonTableCardProps> = (props) => {
  return (
    <div className="flex flex-shrink-0 flex-col py-14 px-6 gap-7 text-text items-center font-mont font-semibold text-base max-md:text-sm border-l-2 border-background w-52 max-md:w-44 relative">
      <div
        style={{
...
const ComparisonTable: Component<ComparisonTableProps> = (props) => {
  ...
  return (
    <div className="flex flex-row bg-background xl:mx-60 lg:mx-36 md:mx-16 sm:mx-8 flex-grow rounded-[20px] border-solid border-background border-2 [background-image:radial-gradient(53%_52%_at_top,rgba(255,255,255,0.15),rgba(255,255,255,0))] max-xl:overflow-x-scroll scroll-smooth overflow-hidden">
      <div className="flex flex-col py-14 px-10 max-sm:px-8 gap-7 text-text font-mont text-base max-md:text-sm font-semibold [background-image:radial-gradient(143%_46%_at_bottom_left_,rgba(61,138,255,0.50),rgba(34,71,126,0.50),rgba(13,17,23,0.2))] max-lg:sticky -left-1 sm:sticky lg:bg-background  max-sm:bg-background z-[1]">
        <div
          style={{
            backgroundImage: "url(/noise.webp)",
            backgroundSize: "30%",
